...
#ifndef LV_ATTRIBUTE_IMG_CD1
#define LV_ATTRIBUTE_IMG_CD1
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_CD1 uint8_t cd1_map[] = {
