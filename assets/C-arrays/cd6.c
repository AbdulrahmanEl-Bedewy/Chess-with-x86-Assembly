...
#ifndef LV_ATTRIBUTE_IMG_CD6
#define LV_ATTRIBUTE_IMG_CD6
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_CD6 uint8_t cd6_map[] = {
