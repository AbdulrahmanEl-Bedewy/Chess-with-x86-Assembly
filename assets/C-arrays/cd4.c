...
#ifndef LV_ATTRIBUTE_IMG_CD4
#define LV_ATTRIBUTE_IMG_CD4
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_CD4 uint8_t cd4_map[] = {
