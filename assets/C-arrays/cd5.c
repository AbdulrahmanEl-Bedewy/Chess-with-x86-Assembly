...
#ifndef LV_ATTRIBUTE_IMG_CD5
#define LV_ATTRIBUTE_IMG_CD5
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_CD5 uint8_t cd5_map[] = {
