...
#ifndef LV_ATTRIBUTE_IMG_CD7
#define LV_ATTRIBUTE_IMG_CD7
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_CD7 uint8_t cd7_map[] = {
