...
#ifndef LV_ATTRIBUTE_IMG_CD3
#define LV_ATTRIBUTE_IMG_CD3
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_CD3 uint8_t cd3_map[] = {
